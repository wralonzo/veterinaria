...
@Component({
  selector: 'app-modal-update-constancy',
  standalone: true,
  imports: [SharedModalModule],
  templateUrl: './modal-update.component.html',
  styleUrl: './modal-update.component.css',
})
export class ModalUpdateConstancyComponent {
  formGroup!: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModalUpdateConstancyComponent>,
    private axiosService: AxiosService,
    private _snackBar: MatSnackBar,
    @Inject(MAT_DIALOG_DATA) public data: IConstancy
  ) {}
